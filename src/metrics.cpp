        ...
        CAmount mature {0};
        {
            ...
            while (it != u->end()) {
                ...
                if (mapBlockIndex.count(hash) > 0 &&
                    ...
                    const CAmount issuanceReserve{(blockIndex->pprev == nullptr) ? MAX_MONEY : blockIndex->pprev->GetIssuanceReserve()};
                    CAmount subsidy = consensusParams.GetBlockSubsidy(height, issuanceReserve);
